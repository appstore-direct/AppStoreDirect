module github.com/appstoredirect/bridge

go 1.25.0

replace github.com/majd/ipatool/v2 => ../third_party/ipatool

require (
	github.com/juju/persistent-cookiejar v1.0.0
	github.com/majd/ipatool/v2 v2.0.0-00010101000000-000000000000
